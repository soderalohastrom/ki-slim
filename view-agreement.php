...
<head>
	<meta charset="utf-8" />
    <title>Kelleher International Expectations Agreement View</title>
...
<form class="m-form m-form--state" action="submit-agreement.php" method="post">
...
<div class="text-center"><img src="/assets/app/media/img/logos/kelleher-contract-logo.jpg" /><br /><h4 style="margin-left:75px;"> Expectation Agreement</h4></div>
...
<div class="text-center">
	<div><button id="btnSubmit" class="btn btn-lg btn-primary" type="submit">Submit Expectations Agreement</button></div>
