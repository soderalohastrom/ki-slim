...
?>
<div class="m-content">
	<?php echo $DATATABLE->render_datatable("myclientsTable", '<i class="flaticon-user-ok"></i> Active Resources - <small>all resources currently active</small>', "/ajax/getTableData.php", $methodSQL, $tableFields, 'Person_id', 'LastName', 'asc', 10)?>
</div>
