        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a href="/debrief-qmanage/0" class="m-portlet__nav-link btn btn-accent m-btn m-btn--pill">
        ...
        var e = JSON.parse('<?php echo $U_DATA?>'),
            a = $(".m_datatable").mDatatable({
                ...
                columns: [{
                    ...
                    overflow: "visible",
                    template: function(e) {
                        return '<a href="/debrief-qmanage/'+e.Questions_id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="View "><i class="la la-edit"></i></a>\t\t\t\t\t'
                    }
                }],				
            }),
...
jQuery(document).ready(function() {
	...
	if( $('#SortQuestions_15').length ) {
		var sortable = Sortable.create(document.getElementById('SortQuestions_15'), {
...
function saveOrder() {
	...
	$.post('/ajax/questions.mgt.php?action=saveOrder', formData, function(data) {
		alert('Debriefing Question Order Saved');
