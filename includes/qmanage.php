...
foreach($typeSnd as $typeDta):
	...
	if ($Q_DATA['QuestionTypes_id'] == $typeDta['QuestionTypes_id']) {
		$TypeDisplay = $typeDta['QuestionTypes_name'];
	}
endforeach;
    ...
    <form class="m-form" id="question-form" name="qForm" action="javascript:submitQform();">
                	...
                	<div class="col-lg-6">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <?php else: ?>
                                <input type="hidden" name="QuestionTypes_id" id="QuestionTypes_id" value="<?php echo $Q_DATA['QuestionTypes_id']?>" />
                            ...
                            <div class="col-lg-8">
                                <div class="m-checkbox-inline">
                                    <label class="m-checkbox">
                                        <input type="checkbox" name="Questions_inPortal" id="Questions_inPortal" value="1" <?php echo (($Q_DATA['Questions_inPortal'] == 1)? 'checked':'')?>>
        ...
        <div class="m-portlet__foot m-portlet__foot--fit">
            <div class="m-form__actions m-form__actions">
                <div class="row">
                    <div class="col-lg-6">
                    	<a href="/qmanager" class="btn btn-secondary"><i class="fa fa-arrow-left"></i> Back to Questions</a>
...
function submitQform() {
	...
	$.post('/ajax/questions.mgt.php?action=submitQuestion', formData, function(data) {
		if(data.newRecord) {
			...
			document.location.href='/qmanage/'+data.newQID;
		} else {
