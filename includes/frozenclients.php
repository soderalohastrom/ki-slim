...
?>
<div class="m-content">
	<?php echo $DATATABLE->render_datatable("myclientsTable", '<i class="flaticon-user-ok"></i> Frozen Clients - <small>clients that are currently frozen</small>', "/ajax/getTableData.php", $methodSQL, $tableFields, 'Person_id', 'LastName', 'asc', 10, false, false, 'false', 'false')?>
</div>
