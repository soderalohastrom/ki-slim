...
?>
<div class="m-content">
	<?php echo $DATATABLE->render_datatable("myclientsTable", '<i class="flaticon-user-ok"></i> Trial Members - <small>records currently in a Trial Membership state.</small>', "/ajax/getTableData.php", $methodSQL, $tableFields, 'Person_id', 'LastName', 'asc', 10, false, false, 'false', 'false')?>
</div>
