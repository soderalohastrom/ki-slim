...
?>
<div class="m-content">
	<?php echo $DATATABLE->render_datatable("allleadsTable", '<i class="flaticon-paper-plane"></i> Pending Particpating Members - <small></small>', "/ajax/getTableData.php", $methodSQL, $tableFields, 'Person_id', 'DateCreated', 'desc', 10, false, false, 'false', 'false')?>
</div>
<script>
