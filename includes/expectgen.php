		...
		'fields'		=>	array(
			'special'	=>	array(
				array(
					...
					'type'	=>	'checkbox',
					'values'=>	array(
						'My photos may be shared with potential candidates',
						'I must submit Feedback on my previous match before another will be presented',
						'All requests to go inactive/active need to be confirmed in writing',
						'I understand that I will meet paying clients and invited Participating Members (PMs)'
					)
				)
			)	
		)
        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                ...
                <h3 class="m-portlet__head-text">
                    <i class="flaticon-file-1"></i> Expectation Agreement Generator
                </h3>
            </div>
        </div>
    </div>
				...
				<div class="container-fluid">
                    ...
                    <div class="m-alert m-alert--icon m-alert--icon-solid m-alert--outline alert alert-danger alert-dismissible fade show" role="alert" style="">
                        ...
                        <div class="m-alert__text">
                        	<?php
							$contractURL = 'https://'.$_SERVER['SERVER_NAME'].'/view-agreement.php?id='.$pe_dta['Expect_Hash'];
...
<?php if($pe_dta['SubmitStatus'] == 1): ?> 
                ...
                <h4 style="margin-left:75px;">EXPECTATIONS OVERVIEW</h4></div>
...
<div class="m-form__group form-group row">
    <label class="col-md-3 col-form-label">
    	Special Agreements
        <span class="m-form__help">Blank lines will be ignored.</span>
	</label>
    <div class="col-md-9" id="specialAgreements">
        <div class="input-group m-form__group">
            ...
            <input type="text" class="form-control" name="specialAgreements[]" value="<?php echo $fData['specialAgreements'][0]?>">
            <span class="input-group-btn">
                <button class="btn btn-secondary" type="button" onclick="dupSpecialAddon('')"><i class="fa fa-plus"></i></button>
            </span>            
        </div>        
    </div>
</div>
                ...
                <table width="650" border="0" cellspacing="0" cellpadding="0" align="center">                            
                    <tr>
                        <td colspan="2">
                            <p>The criteria presented in this overview will be the basis of what Kelleher International will use to conduct a search on my behalf through the terms of the Membership Agreement.</p>
                        </td>
                    <tr>
                        <td width="70%">
                            <div>&nbsp;Client Name:</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" align="center" style="border:#333 solid 1px;">
	<tr>
...
function submit_expect_form() {
	...
	$.post('/ajax/expect_mgr.php?action=submit', formData, function(data) {
		document.location.href='/expectgen/<?php echo $PERSON_ID?>/'+data.agid;			
	},"json");
}
