...
if($cDATA['empty_result'] == 1):
    ...
    <div class="m-alert m-alert--icon m-alert--icon-solid m-alert--outline alert alert-success alert-dismissible fade show" role="alert">
        ...
        <div class="m-alert__text">
            <strong>Addendum Submitted</strong><br>
            You should recieve a copy of the addendum in your email inbox.
        </div>
    </div>
    <?php
	$PAGE_OUTPUT = ob_get_clean();
...
$notifySubject = "Expecations Addendum Signed: ".$cDATA['Contract_name'];
$notifyBody = "
			
This is an automated message to notify you that an expectations addendum signature has been submitted (".$cDATA['Contract_name']."). 
...
";
	...
	$mail->FromName = 'Kelleher International Expectations Addendum Manager';
